...
//   const donutChartSeries = [500, 500, 500];
...
//   const createChartTwo = (chartColor: unknown, height: string | number | undefined) => {
//     const series = [
//       {
//         name: "This Day",
...
//   const createChartThree = (chartColor: unknown) => {
//     const currentYear = new Date().getFullYear();
//     const series = [
//       {
//         name: "series1",
...
//   const createChartFour = (chartColor: unknown, height: string | number | undefined, width: string | number | undefined) => {
//     const currentYear = new Date().getFullYear();
...
//   const createChartFive = (chartColor) => {
//     const currentYear = new Date().getFullYear();
...
//   const createChartSeven = (color1, color2) => {
//     const series = [
//       {
//         name: "series2",
//         data: [
...
//   const donutChartSeriesTwo = [500, 500, 500];
...
//   const statisticsDonutChartSeries = [30, 25];
...
//   const statisticsDonutChartSeriesThree = [30, 25];
...
//   const dailyIconBarChartSeriesOne = [
//     {
//       name: "Sales",
//       data: [
//         {
...
//   const transactionLineChartSeries = [
//     {
//       name: "This month",
...
//   const userOverviewDonutChartSeries = [500, 500, 500];
...
//   const dailyIconBarChartSeriesTwo = [
//     {
//       name: "Sales",
//       data: [
//         {
...
//   const pieChartSeriesOne = [70, 80, 90, 30];
...
//   const basicDonutChartSeries = [44, 55, 13, 33, 28, 14];
...
//   const multipleSeriesChartSeries = [20, 22, 28, 10];
...
//   const timeSeriesChartSeriesTwo = [
//     {
//       name: "Bitcoin",
//       data: [
//         [1327359600000, 30.95],
...
//     },
//   ];
//   const timeSeriesChartOptionsTwo = {
//     chart: {
//       type: "area",
//       stacked: false,
//       height: 350,
...
//   const paymentStatusChartOptionsFour = {
//     colors: ["#45B369", "#FF9F29"],
//     labels: ["Active", "New", "Total"],
...
//   const paymentStatusChartSeriesFour = [
//     {
//       name: "Net Profit",
//       data: [44, 100, 40, 56, 30, 58, 50],
//     },
...
//   const statisticsDonutChartOptionsTwo = {
...
//   const statisticsDonutChartSeriesTwo = [30, 25];
...
//   const userOverviewDonutChartSeriesOne = [500, 500, 500];
...
//   const userOverviewDonutChartSeriesTwo = [30, 30, 20, 20];
...
//   const expenseStatisticsSeries = [30, 30, 30, 30];
